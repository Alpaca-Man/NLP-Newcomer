...
# RNN
model = RNN(dataProcessor.voc_size, emb_size, hidden_size, len(dataProcessor.label_types), num_layers=num_layers, nonlinearity=nonlinearity, dropout=dropout,bidirectional=bidirectional).to(device)
