...
# RNN
model = RNN(vocab_size, emb_size, hidden_size, num_classes, num_layers=num_layers, nonlinearity=nonlinearity, dropout=dropout,bidirectional=bidirectional).to(device)
